...
//                C06731 r1 = new BroadcastReceiver() {
...
//                application.registerReceiver(r1, intentFilter);
    ...
    public static boolean isLoggingEnableDevice(Context context) {
        ...
        boolean z = false;
        int i = preferences.getInt("enable_device", 0);
        if (i == 0) {
            ...
            try {
                ...
                z = ((Boolean) cls.getMethod(str, new Class[]{String.class}).invoke(cls.getMethod("getInstance", (Class[]) null).invoke((Object) null, new Object[0]), new Object[]{"SEC_FLOATING_FEATURE_CONTEXTSERVICE_ENABLE_SURVEY_MODE"})).booleanValue();
            } catch (Exception e) {
                try {
...
//                }
            ...
            if (!z) {
                ...
                preferences.edit().putInt("enable_device", 2).apply();
                return z;
            }
            Debug.LogD("cf feature is supported");
            preferences.edit().putInt("enable_device", 1).apply();
            return z;
        } else if (i == 1) {
            return true;
        } else {
