...
public class DLSAPIClient implements AsyncTaskClient {
    ...
    public DLSAPIClient(SimpleLog simpleLog2, String str, int i, AsyncTaskCallback asyncTaskCallback2) {
        this.simpleLog = simpleLog2;
        this.trid = str;
        this.asyncTaskCallback = asyncTaskCallback2;
        this.timeoutInMilliseconds = getTimeout(i);
        this.logType = simpleLog2.getType();
    }

    public DLSAPIClient(LogType logType2, Queue<SimpleLog> queue, String str, int i, AsyncTaskCallback asyncTaskCallback2) {
        this.logs = queue;
        this.trid = str;
        this.asyncTaskCallback = asyncTaskCallback2;
        this.isBatch = true;
    ...
    private String getBody() {
        ...
        String data = ((SimpleLog) it.next()).getData();
        while (it.hasNext()) {
            data = data + "\u000e" + ((SimpleLog) it.next()).getData();
        }
        return data;
    }
