...
import com.sec.android.app.voicenote.service.helper.WaveMaker;
...
public class MetadataRepository {
    ...
    private static volatile MetadataRepository mInstance;
    ...
    public static MetadataRepository getInstance() {
        if (mInstance == null) {
            synchronized (MetadataRepository.class) {
                if (mInstance == null) {
                    mInstance = new MetadataRepository();
                }
            }
        }
        return mInstance;
    ...
    public synchronized void registerListener(com.sec.android.app.voicenote.service.MetadataRepository.OnVoiceMetadataListener r4) {
        /*
            r3 = this;
            monitor-enter(r3)
        ...
        L_0x000a:
            ...
            java.util.ArrayList<com.sec.android.app.voicenote.service.MetadataRepository$OnVoiceMetadataListener> r0 = r3.mListeners     // Catch:{ all -> 0x002f }
        ...
        L_0x0032:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.sec.android.app.voicenote.service.MetadataRepository.registerListener(com.sec.android.app.voicenote.service.MetadataRepository$OnVoiceMetadataListener):void");
    }
     ...
     */
    /* JADX WARNING: Removed duplicated region for block: B:110:0x0322  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public boolean read(java.lang.String r17) {
        /*
            r16 = this;
            r1 = r16
            r2 = r17
            r3 = 0
            java.lang.String r4 = "MetadataRepository"
        ...
        L_0x008a:
            ...
            r7.<init>()
            java.lang.String r0 = r1.mPath     // Catch:{ IOException -> 0x00b4, NullPointerException -> 0x00ab }
            if (r0 == 0) goto L_0x00bc
            java.lang.String r0 = r1.mPath     // Catch:{ IOException -> 0x00b4, NullPointerException -> 0x00ab }
            r7.setDataSource(r0)     // Catch:{ IOException -> 0x00b4, NullPointerException -> 0x00ab }
            int r0 = r7.getTrackCount()     // Catch:{ IOException -> 0x00b4, NullPointerException -> 0x00ab }
            if (r0 <= 0) goto L_0x00bc
            android.media.MediaFormat r0 = r7.getTrackFormat(r3)     // Catch:{ IOException -> 0x00b4, NullPointerException -> 0x00ab }
            java.lang.String r10 = "channel-count"
            int r0 = r0.getInteger(r10)     // Catch:{ IOException -> 0x00b4, NullPointerException -> 0x00ab }
            r1.mChCount = r0     // Catch:{ IOException -> 0x00b4, NullPointerException -> 0x00ab }
            goto L_0x00bc
        L_0x00ab:
            r0 = move-exception
            java.lang.String r0 = r0.toString()
        ...
        L_0x0187:
            ...
            r8.<init>()
            java.lang.String r10 = "wave NEED to CONVERT "
            r8.append(r10)
            r8.append(r5)
            ...
            r5.<init>()
            java.lang.String r8 = "wave CONVERT - duration : "
            r5.append(r8)
            long r10 = r1.mDuration
            r5.append(r10)
            java.lang.String r8 = " oldSize : "
            r5.append(r8)
            r5.append(r0)
            java.lang.String r8 = " newSize : "
            r5.append(r8)
            r5.append(r6)
            ...
            java.lang.StringBuilder r5 = new java.lang.StringBuilder
            r5.<init>()
            java.lang.String r8 = "wave CONVERT - numOfWave : "
            r5.append(r8)
            r5.append(r9)
            java.lang.String r5 = r5.toString()
            com.sec.android.app.voicenote.provider.Log.m26i(r4, r5)
        ...
        L_0x026d:
            ...
            r0.<init>()
            com.sec.android.app.voicenote.service.-$$Lambda$MetadataRepository$hIwzj28TYc_31CNsCH63ysVXOOA r2 = new com.sec.android.app.voicenote.service.-$$Lambda$MetadataRepository$hIwzj28TYc_31CNsCH63ysVXOOA
            r2.<init>()
        ...
        L_0x032c:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.sec.android.app.voicenote.service.MetadataRepository.read(java.lang.String):boolean");
    }

    public /* synthetic */ void lambda$read$0$MetadataRepository(String str, int[] iArr) {
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public synchronized void write(java.lang.String r7) {
        /*
            r6 = this;
            monitor-enter(r6)
            if (r7 != 0) goto L_0x000c
            java.lang.String r7 = "MetadataRepository"
            java.lang.String r0 = "write - path is null"
            com.sec.android.app.voicenote.provider.Log.m22e(r7, r0)     // Catch:{ all -> 0x01cb }
            monitor-exit(r6)
            return
        L_0x000c:
            java.io.File r0 = new java.io.File     // Catch:{ all -> 0x01cb }
            r0.<init>(r7)     // Catch:{ all -> 0x01cb }
            boolean r0 = r0.exists()     // Catch:{ all -> 0x01cb }
            if (r0 != 0) goto L_0x003a
            java.lang.String r0 = "MetadataRepository"
            java.lang.String r1 = "write - file not exist"
            com.sec.android.app.voicenote.provider.Log.m22e(r0, r1)     // Catch:{ all -> 0x01cb }
            boolean r0 = com.sec.android.app.voicenote.provider.Log.ENG     // Catch:{ all -> 0x01cb }
            if (r0 == 0) goto L_0x0038
            java.lang.String r0 = "MetadataRepository"
            java.lang.StringBuilder r1 = new java.lang.StringBuilder     // Catch:{ all -> 0x01cb }
            r1.<init>()     // Catch:{ all -> 0x01cb }
            java.lang.String r2 = "write - file not exist - path : "
            r1.append(r2)     // Catch:{ all -> 0x01cb }
            r1.append(r7)     // Catch:{ all -> 0x01cb }
            java.lang.String r7 = r1.toString()     // Catch:{ all -> 0x01cb }
            com.sec.android.app.voicenote.provider.Log.m22e(r0, r7)     // Catch:{ all -> 0x01cb }
        L_0x0038:
            monitor-exit(r6)
            return
        L_0x003a:
            ...
            r1.append(r2)     // Catch:{ all -> 0x01cb }
            java.lang.String r2 = r6.getTitle((java.lang.String) r7)     // Catch:{ all -> 0x01cb }
            r1.append(r2)     // Catch:{ all -> 0x01cb }
            java.lang.String r1 = r1.toString()     // Catch:{ all -> 0x01cb }
            com.sec.android.app.voicenote.provider.Log.m19d(r0, r1)     // Catch:{ all -> 0x01cb }
            r0 = 0
            java.io.FileWriter r1 = r6.mFileWriter     // Catch:{ IOException -> 0x006c }
            if (r1 == 0) goto L_0x0060
            java.io.FileWriter r1 = r6.mFileWriter     // Catch:{ IOException -> 0x006c }
            r1.close()     // Catch:{ IOException -> 0x006c }
            r6.mFileWriter = r0     // Catch:{ IOException -> 0x006c }
        L_0x0060:
            java.io.BufferedWriter r1 = r6.mBufferWriter     // Catch:{ IOException -> 0x006c }
            if (r1 == 0) goto L_0x0076
            java.io.BufferedWriter r1 = r6.mBufferWriter     // Catch:{ IOException -> 0x006c }
            r1.close()     // Catch:{ IOException -> 0x006c }
            r6.mBufferWriter = r0     // Catch:{ IOException -> 0x006c }
            goto L_0x0076
        L_0x006c:
            r1 = move-exception
            java.lang.String r2 = "MetadataRepository"
            java.lang.String r1 = r1.getMessage()     // Catch:{ all -> 0x01cb }
            com.sec.android.app.voicenote.provider.Log.m22e(r2, r1)     // Catch:{ all -> 0x01cb }
        L_0x0076:
            boolean r1 = r6.mIsDataChanged     // Catch:{ all -> 0x01cb }
            if (r1 == 0) goto L_0x01c7
            java.lang.String r1 = "MetadataRepository"
            java.lang.String r2 = "write - need to be updated"
            com.sec.android.app.voicenote.provider.Log.m26i(r1, r2)     // Catch:{ all -> 0x01cb }
            com.sec.android.app.voicenote.service.codec.M4aReader r1 = new com.sec.android.app.voicenote.service.codec.M4aReader     // Catch:{ all -> 0x01cb }
            r1.<init>(r7)     // Catch:{ all -> 0x01cb }
            java.util.ArrayList<com.sec.android.app.voicenote.service.helper.Bookmark> r2 = r6.mBookmarkList     // Catch:{ all -> 0x01cb }
            r3 = 0
            if (r2 == 0) goto L_0x00d5
            java.lang.String r2 = "MetadataRepository"
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ all -> 0x01cb }
            r4.<init>()     // Catch:{ all -> 0x01cb }
            java.lang.String r5 = "write bookmark info - size : "
            r4.append(r5)     // Catch:{ all -> 0x01cb }
            java.util.ArrayList<com.sec.android.app.voicenote.service.helper.Bookmark> r5 = r6.mBookmarkList     // Catch:{ all -> 0x01cb }
            int r5 = r5.size()     // Catch:{ all -> 0x01cb }
            r4.append(r5)     // Catch:{ all -> 0x01cb }
            java.lang.String r4 = r4.toString()     // Catch:{ all -> 0x01cb }
            com.sec.android.app.voicenote.provider.Log.m26i(r2, r4)     // Catch:{ all -> 0x01cb }
            com.sec.android.app.voicenote.service.codec.M4aInfo r2 = r1.readFile()     // Catch:{ all -> 0x01cb }
            if (r2 != 0) goto L_0x00b6
            java.lang.String r7 = "MetadataRepository"
            java.lang.String r0 = "write info is null !!!"
            com.sec.android.app.voicenote.provider.Log.m26i(r7, r0)     // Catch:{ all -> 0x01cb }
            monitor-exit(r6)
            return
        L_0x00b6:
            com.sec.android.app.voicenote.service.helper.BookmarksHelper r4 = new com.sec.android.app.voicenote.service.helper.BookmarksHelper     // Catch:{ all -> 0x01cb }
            r4.<init>(r2)     // Catch:{ all -> 0x01cb }
            java.util.ArrayList<com.sec.android.app.voicenote.service.helper.Bookmark> r2 = r6.mBookmarkList     // Catch:{ all -> 0x01cb }
            java.util.Collections.sort(r2)     // Catch:{ all -> 0x01cb }
            java.util.ArrayList<com.sec.android.app.voicenote.service.helper.Bookmark> r2 = r6.mBookmarkList     // Catch:{ all -> 0x01cb }
            r4.overwrite(r2)     // Catch:{ all -> 0x01cb }
            com.sec.android.app.voicenote.service.BookmarkHolder r2 = com.sec.android.app.voicenote.service.BookmarkHolder.getInstance()     // Catch:{ all -> 0x01cb }
            int r4 = r4.getBookmarksCount()     // Catch:{ all -> 0x01cb }
        ...
        L_0x00d1:
            r4 = r3
        L_0x00d2:
            r2.set(r7, r4)     // Catch:{ all -> 0x01cb }
        L_0x00d5:
            int[] r2 = r6.mWaveData     // Catch:{ all -> 0x01cb }
            if (r2 == 0) goto L_0x010e
            java.lang.String r2 = "MetadataRepository"
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ all -> 0x01cb }
            r4.<init>()     // Catch:{ all -> 0x01cb }
            java.lang.String r5 = "write amplitude data length : "
            r4.append(r5)     // Catch:{ all -> 0x01cb }
            int[] r5 = r6.mWaveData     // Catch:{ all -> 0x01cb }
            int r5 = r5.length     // Catch:{ all -> 0x01cb }
            r4.append(r5)     // Catch:{ all -> 0x01cb }
            java.lang.String r4 = r4.toString()     // Catch:{ all -> 0x01cb }
            com.sec.android.app.voicenote.provider.Log.m26i(r2, r4)     // Catch:{ all -> 0x01cb }
            com.sec.android.app.voicenote.service.codec.M4aInfo r2 = r1.readFile()     // Catch:{ all -> 0x01cb }
            ...
            return
        L_0x0101:
            r6.createMeetingData()     // Catch:{ all -> 0x01cb }
            com.sec.android.app.voicenote.service.helper.WaveHelper r4 = new com.sec.android.app.voicenote.service.helper.WaveHelper     // Catch:{ all -> 0x01cb }
            r4.<init>(r2)     // Catch:{ all -> 0x01cb }
            int[] r2 = r6.mWaveData     // Catch:{ all -> 0x01cb }
            r4.overwrite(r2)     // Catch:{ all -> 0x01cb }
        L_0x010e:
            com.sec.android.app.voicenote.common.util.MeetingData r2 = r6.mMeetingData     // Catch:{ all -> 0x01cb }
            if (r2 == 0) goto L_0x0132
            java.lang.String r2 = "MetadataRepository"
            java.lang.String r4 = "write meeting data"
            com.sec.android.app.voicenote.provider.Log.m26i(r2, r4)     // Catch:{ all -> 0x01cb }
            com.sec.android.app.voicenote.service.codec.M4aInfo r2 = r1.readFile()     // Catch:{ all -> 0x01cb }
            ...
            return
        L_0x0128:
            com.sec.android.app.voicenote.common.util.MeetingDataHelper r4 = new com.sec.android.app.voicenote.common.util.MeetingDataHelper     // Catch:{ all -> 0x01cb }
            r4.<init>(r2)     // Catch:{ all -> 0x01cb }
            com.sec.android.app.voicenote.common.util.MeetingData r2 = r6.mMeetingData     // Catch:{ all -> 0x01cb }
            r4.overwrite(r2)     // Catch:{ all -> 0x01cb }
        L_0x0132:
            java.util.ArrayList<com.sec.android.app.voicenote.common.util.TextData> r2 = r6.mSttData     // Catch:{ all -> 0x01cb }
            if (r2 != 0) goto L_0x0142
            java.util.ArrayList<com.sec.android.app.voicenote.common.util.TextData> r2 = r6.mDisplayedSttData     // Catch:{ all -> 0x01cb }
            if (r2 == 0) goto L_0x0142
            java.util.ArrayList r0 = new java.util.ArrayList     // Catch:{ all -> 0x01cb }
            java.util.ArrayList<com.sec.android.app.voicenote.common.util.TextData> r2 = r6.mDisplayedSttData     // Catch:{ all -> 0x01cb }
            r0.<init>(r2)     // Catch:{ all -> 0x01cb }
            goto L_0x014d
        L_0x0142:
            java.util.ArrayList<com.sec.android.app.voicenote.common.util.TextData> r2 = r6.mSttData     // Catch:{ all -> 0x01cb }
        ...
        L_0x014d:
            ...
            return
        L_0x0165:
            com.sec.android.app.voicenote.service.helper.SttHelper r4 = new com.sec.android.app.voicenote.service.helper.SttHelper     // Catch:{ all -> 0x01cb }
            r4.<init>(r2)     // Catch:{ all -> 0x01cb }
            r4.overwrite(r0)     // Catch:{ all -> 0x01cb }
        L_0x016d:
            int r0 = r6.mRecordMode     // Catch:{ all -> 0x01cb }
            ...
            int r4 = r6.mRecordMode     // Catch:{ all -> 0x01cb }
            r2.append(r4)     // Catch:{ all -> 0x01cb }
            java.lang.String r2 = r2.toString()     // Catch:{ all -> 0x01cb }
            com.sec.android.app.voicenote.provider.Log.m26i(r0, r2)     // Catch:{ all -> 0x01cb }
            com.sec.android.app.voicenote.service.codec.M4aInfo r0 = r1.readFile()     // Catch:{ all -> 0x01cb }
            ...
            return
        L_0x0198:
            com.sec.android.app.voicenote.service.helper.SmtaHelper r2 = new com.sec.android.app.voicenote.service.helper.SmtaHelper     // Catch:{ all -> 0x01cb }
            r2.<init>(r0)     // Catch:{ all -> 0x01cb }
            int r0 = r6.mRecordMode     // Catch:{ all -> 0x01cb }
            r2.overwrite(r0)     // Catch:{ all -> 0x01cb }
        L_0x01a2:
            com.sec.android.app.voicenote.service.codec.M4aInfo r0 = r1.readFile()     // Catch:{ all -> 0x01cb }
            ...
            return
        L_0x01b1:
            com.sec.android.app.voicenote.common.util.VoiceRecorderData r1 = r6.mVoiceRecorderData     // Catch:{ all -> 0x01cb }
            if (r1 == 0) goto L_0x01c5
            com.sec.android.app.voicenote.service.helper.VoiceRecorderDataHelper r1 = new com.sec.android.app.voicenote.service.helper.VoiceRecorderDataHelper     // Catch:{ all -> 0x01cb }
            r1.<init>(r0)     // Catch:{ all -> 0x01cb }
            com.sec.android.app.voicenote.common.util.VoiceRecorderData r0 = r6.mVoiceRecorderData     // Catch:{ all -> 0x01cb }
            java.lang.String r2 = r6.mCategoryName     // Catch:{ all -> 0x01cb }
            r0.mCategoryName = r2     // Catch:{ all -> 0x01cb }
            com.sec.android.app.voicenote.common.util.VoiceRecorderData r0 = r6.mVoiceRecorderData     // Catch:{ all -> 0x01cb }
            r1.overwrite(r0)     // Catch:{ all -> 0x01cb }
        L_0x01c5:
            r6.mIsDataChanged = r3     // Catch:{ all -> 0x01cb }
        L_0x01c7:
            r6.mPath = r7     // Catch:{ all -> 0x01cb }
            monitor-exit(r6)
            return
        L_0x01cb:
            r7 = move-exception
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.sec.android.app.voicenote.service.MetadataRepository.write(java.lang.String):void");
    }
    ...
    private int getRecQualityMode(java.lang.String r7) {
        ...
        L_0x004d:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.sec.android.app.voicenote.service.MetadataRepository.getRecQualityMode(java.lang.String):int");
    }
    ...
    public void addBookmark(int i) {
        Log.m26i(TAG, "addBookmark - time : " + i + " hash : " + hashCode());
        if (this.mBookmarkList.size() < 50) {
            this.mBookmarkList.add(new Bookmark(i, "", String.format(Locale.getDefault(), "%d", new Object[]{Long.valueOf(System.currentTimeMillis())}), true));
    ...
    public void removeBookmark(int i) {
        Log.m26i(TAG, "removeBookmark - time : " + i);
    ...
    public boolean addSilenceSttData(int r18, int r19) {
        ...
        L_0x002d:
            ...
            java.lang.String r5 = "MetadataRepository"
        ...
        L_0x00c5:
            return r16
        */
        throw new UnsupportedOperationException("Method not decompiled: com.sec.android.app.voicenote.service.MetadataRepository.addSilenceSttData(int, int):boolean");
    }
